...
number of rows in genere table:14662
...
/* 4285 movies are produced under drama genre
...
WHERE year = 2017 and country = 'USA' and MONTH(date_published) = '03' and r.total_votes > 1000
GROUP BY g.genre
ORDER BY movie_count DESC
...
-- Type your code below:
SELECT count(m.id)as total_count,r.median_rating
FROM movie AS m
INNER JOIN
ratings AS r
ON
